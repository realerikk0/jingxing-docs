...
const sidebars: SidebarsConfig = {
  tutorialSidebar: [
    ...
    },
    {
      type: 'category',
      label: '视频',
      className: 'sidebar-icon-video',
      collapsible: true,
      collapsed: false,
      items: [
        {
          type: 'doc',
          id: 'models/video-generation',
          label: 'OpenAI 兼容视频生成',
          className: 'sidebar-icon-video-gen',
        },
        {
          type: 'doc',
          id: 'models/video-task-status',
          label: '视频任务状态查询',
          className: 'sidebar-icon-video-task',
        },
        {
          type: 'doc',
          id: 'models/kling-text-to-video',
          label: 'Kling 文生视频',
          className: 'sidebar-icon-kling-text',
        },
        {
          type: 'doc',
          id: 'models/kling-image-to-video',
          label: 'Kling 图生视频',
          className: 'sidebar-icon-kling-image',
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          label: 'Embeddings',
          className: 'sidebar-icon-embeddings',
        },
      ],
    },
    {
      type: 'category',
      label: '音频与实时',
      className: 'sidebar-icon-audio',
      collapsible: true,
      collapsed: false,
      items: [
        {
          type: 'doc',
          id: 'models/audio-and-realtime',
          label: '音频与 Realtime',
          className: 'sidebar-icon-audio-item',
        },
      ],
    },
    {
