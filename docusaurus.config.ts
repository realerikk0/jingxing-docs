...
const config: Config = {
  ...
  organizationName: 'realerikk0', // Usually your GitHub org/user name.
  projectName: 'jingxing-docs', // Usually your repo name.
